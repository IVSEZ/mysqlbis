...
drop table if exists rcb_cmts;

CREATE TABLE `rcb_cmts` (
...
create index IDXrcbcmts1 on rcbill.rcb_cmts (MAC_ADDRESS_CLEAN2);
create index IDXrcbcmts2 on rcbill.rcb_cmts (INSERTEDON);
