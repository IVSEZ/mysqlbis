...
-- LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 5.7\\Uploads\\CMTSMXK\\CMTS_List_20210106-1131.csv' 
 LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 5.7\\Uploads\\CMTSMXK\\CMTS_List_20220907-1011.csv' 
...
delete from rcbill.rcb_cmts where date(insertedon)='2021-03-10' and mac_address='';
delete from rcbill.rcb_cmts where date(insertedon)='2021-03-10' and mac_address='MAC';

delete from rcbill.rcb_cmts where mac_address='';
delete from rcbill.rcb_cmts where mac_address='MAC';
*/
