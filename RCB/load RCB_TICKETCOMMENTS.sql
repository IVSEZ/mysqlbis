...
LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 5.7\\Uploads\\rcbill\\AllTicketComments-26122017.csv' 
...
-- select * from rcbill.rcb_ticketcomments where ticketid=863585;