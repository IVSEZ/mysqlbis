...
select 	"SERVICEINSTANCENUMBER",	"PACKAGENAME",	"SERVICESTARTDATE",	"SERVICEENDDATE",	"SUBLASTSTARTDATE",	"SUBLASTENDDATE",	"OVERRIDDEN"

union all

select 	ifnull(SERVICEINSTANCENUMBER,""),	ifnull(PACKAGENAME,""),	ifnull(SERVICESTARTDATE,""),	ifnull(SERVICEENDDATE,""),	ifnull(SUBLASTSTARTDATE,""),	ifnull(SUBLASTENDDATE,""),	ifnull(OVERRIDDEN,"")
