...
select 	"SERVICEINSTANCENUMBER",	"PACKAGENAME",	"SERVICESTARTDATE",	"SERVICEENDDATE",	"LASTSUBSTARTDATE",	"LASTSUBENDDATE",	"OVERRIDDEN"

union all

select 	ifnull(SERVICEINSTANCENUMBER,""),	ifnull(PACKAGENAME,""),	ifnull(SERVICESTARTDATE,""),	ifnull(SERVICEENDDATE,""),	ifnull(LASTSUBSTARTDATE,""),	ifnull(LASTSUBENDDATE,""),	ifnull(OVERRIDDEN,"")
