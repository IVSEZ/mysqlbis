...
INTO OUTFILE '/var/www/html/STL_EXTRACT/IV_CUSTOMER_ACCOUNT_20201113-1.csv'
...
INTO OUTFILE '/var/www/html/STL_EXTRACT/IV_BILLING_ACCOUNT_20201113-1.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
ESCAPED BY '\\'
LINES TERMINATED BY '\r\n'
...
INTO OUTFILE '/var/www/html/STL_EXTRACT/IV_SERVICE_ACCOUNT_20201113-1.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
ESCAPED BY '\\'
LINES TERMINATED BY '\r\n'
...
INTO OUTFILE '/var/www/html/STL_EXTRACT/IV_SERVICE_INSTANCE_CHARGE_20201113-1.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
ESCAPED BY '\\'
LINES TERMINATED BY '\r\n'
...
INTO OUTFILE '/var/www/html/STL_EXTRACT/IV_INVENTORY_20201113-1.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
ESCAPED BY '\\'
LINES TERMINATED BY '\r\n'
...
select 	"SERVICEINSTANCENUMBER",	"PACKAGENAME",	"SERVICESTARTDATE",	"SERVICEENDDATE",	"LASTSUBSTARTDATE",	"LASTSUBENDDATE",	"LASTINVFROMDATE",	"LASTINVTODATE",	"CURSUBSTARTDATE",	"CURSUBENDDATE",	"CURSUBPAYDATE",	"CURINVFROMDATE",	"CURINVTODATE",	"OVERRIDDEN"

union all

select 	ifnull(SERVICEINSTANCENUMBER,""),	ifnull(PACKAGENAME,""),	ifnull(SERVICESTARTDATE,""),	ifnull(SERVICEENDDATE,""),	ifnull(LASTSUBSTARTDATE,""),	ifnull(LASTSUBENDDATE,""),	ifnull(LASTINVFROMDATE,""),	ifnull(LASTINVTODATE,""),	ifnull(CURSUBSTARTDATE,""),	ifnull(CURSUBENDDATE,""),	ifnull(CURSUBPAYDATE,""),	ifnull(CURINVFROMDATE,""),	ifnull(CURINVTODATE,""),	ifnull(OVERRIDDEN,"")



INTO OUTFILE '/var/www/html/STL_EXTRACT/IV_ADDON_20201113-1.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
ESCAPED BY '\\'
LINES TERMINATED BY '\r\n'
...
INTO OUTFILE '/var/www/html/STL_EXTRACT/IV_ADDON_CHARGE_20201113-1.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
ESCAPED BY '\\'
LINES TERMINATED BY '\r\n'
...
INTO OUTFILE '/var/www/html/STL_EXTRACT/IV_PAYMENT_HISTORY_20201113-1.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
ESCAPED BY '\\'
LINES TERMINATED BY '\r\n'
...
INTO OUTFILE '/var/www/html/STL_EXTRACT/IV_BILL_SUMMARY_20201113-1.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
ESCAPED BY '\\'
LINES TERMINATED BY '\r\n'
...
INTO OUTFILE '/var/www/html/STL_EXTRACT/IV_BILL_DETAIL_20201113-1.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
ESCAPED BY '\\'
LINES TERMINATED BY '\r\n'
...
INTO OUTFILE '/var/www/html/STL_EXTRACT/IV_NBD_20201113-1.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
ESCAPED BY '\\'
LINES TERMINATED BY '\r\n'
...
INTO OUTFILE '/var/www/html/STL_EXTRACT/IV_DISCOUNT_20201113-1.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
ESCAPED BY '\\'
LINES TERMINATED BY '\r\n'
