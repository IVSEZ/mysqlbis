...
select name, count(*) from  rcbill_extract.billdetailprt00_13 where BILLINGACCOUNTNUMBER_2 is null group by name;

select * from  rcbill_extract.billdetailprt00_13 where BILLINGACCOUNTNUMBER_2 is null;
select * from  rcbill_extract.billdetailprt13;


select BILLINGACCOUNTNUMBER, CUSTOMERACCOUNTNUMBER,SERVICEINSTANCENUMBER, INVOICESUMMARYID
, concat(INVOICEDETAILID,'_1') as INVOICEDETAILID
, concat(SERIALNUMBER,'_1') as SERIALNUMBER, DEBITDOCUMENTNUMBER
...
select * from rcbill_extract.IV_BILLDETAIL where name like 'CHARGE: %';
