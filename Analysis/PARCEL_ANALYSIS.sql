...
create table rcbill_my.rep_custextract_compare20200122 as 
(
	select -- a.*,b.*
...
select * from rcbill_my.rep_custextract_compare20200122 where 0=0 ;
...
(
	...
	select clientcode from rcbill_my.rep_custextract_compare20200122 where 0=0 
