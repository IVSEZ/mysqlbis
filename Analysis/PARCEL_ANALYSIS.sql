...
-- select network from rcbill_my.customercontractactivity where clientcode='I19852' and PERIOD='2019-12-11' limit 1;
...
### this is now in REVENUE PER NODE MXK script run daily
...
select * from rcbill_my.rep_custextract where ONE_YEAR='ONE YEAR' and PARCEL_PRESENT='NOT PRESENT'; -- and clientclass='CORPORATE LARGE';
select clientcode, clientname, clientclass, IsAccountActive, accountactivitystage from rcbill_my.rep_custextract where ONE_YEAR='ONE YEAR' and PARCEL_PRESENT='NOT PRESENT' and clientclass in ('CORPORATE BULK','CORPORATE'); -- and clientclass='CORPORATE LARGE';

select reportdate, count(*) from rcbill_my.rep_custextract where ONE_YEAR='ONE YEAR' and PARCEL_PRESENT='NOT PRESENT' group by reportdate;
