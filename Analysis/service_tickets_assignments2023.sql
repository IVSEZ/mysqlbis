...
drop table if exists rcbill_my.rep_servicetickets_2023;

create table rcbill_my.rep_servicetickets_2023 as 
(
	select a.*
    ...
    (
        ...
        , case 
            ...
            when year(a.assgnopendate)=2023 then 2 
            end as agreeddays
		...
		(
                ...
                where year(ASSGN_OPENDATE)=2023
...
-- show index from rcbill_my.rep_servicetickets_2023;

-- drop index idx1 on rcbill_my.rep_servicetickets_2023;
-- drop index idx2 on rcbill_my.rep_servicetickets_2023;

CREATE INDEX IDXrst1 ON rcbill_my.rep_servicetickets_2023 (assgntechregion);
CREATE INDEX IDXrst2 ON rcbill_my.rep_servicetickets_2023 (assgnopendate);

select count(*) as rep_servicetickets_2023 from rcbill_my.rep_servicetickets_2023;
-- select * from rcbill_my.rep_servicetickets_2023 limit 100;
...
from rcbill_my.rep_servicetickets_2023
;
*/

-- select * from rcbill_my.rep_servicetickets_2023 where ticketid=909247;
-- select *, (packageprice/30) as  priceperday from rcbill_my.rep_servicetickets_2023 where ticketid=910797;

/*
-- tickets opened last month
select date(opendate) as opendate, count(ticketid), count(distinct ticketid) from rcbill_my.rep_servicetickets_2023 where month(opendate)=5 and year(opendate)=2023
...
select * from rcbill_my.rep_servicetickets_2023 where month(opendate)=5 and year(opendate)=2023
and (clean_connection_type = 'HFC' or clean_connection_type is null) and (activenetwork not in ('GPON' , 'GPON|MOBILE TV', 'GPON|GPON') or activenetwork is null)
-- and service='Internet'
;
...
select assgntechregion, count(ticketid) as tickets from rcbill_my.rep_servicetickets_2023 where month(opendate)=5 and year(opendate)=2023
and (clean_connection_type = 'HFC' or clean_connection_type is null) and (activenetwork not in ('GPON' , 'GPON|MOBILE TV', 'GPON|GPON') or activenetwork is null)
group by assgntechregion 
order by 2 desc
;
select assgntechregion, count(distinct ticketid) as d_tickets from rcbill_my.rep_servicetickets_2023 where month(opendate)=5 and year(opendate)=2023
and (clean_connection_type = 'HFC' or clean_connection_type is null) and (activenetwork not in ('GPON' , 'GPON|MOBILE TV', 'GPON|GPON') or activenetwork is null)
group by assgntechregion 
order by 2 desc
;

select clean_hfc_nodename, count(ticketid) as tickets from rcbill_my.rep_servicetickets_2023 where month(opendate)=5 and year(opendate)=2023
and (clean_connection_type = 'HFC' or clean_connection_type is null) and (activenetwork not in ('GPON' , 'GPON|MOBILE TV', 'GPON|GPON') or activenetwork is null)
group by clean_hfc_nodename 
order by 2 desc
;

select clean_hfc_nodename, count(distinct ticketid) as d_tickets from rcbill_my.rep_servicetickets_2023 where month(opendate)=5 and year(opendate)=2023
and (clean_connection_type = 'HFC' or clean_connection_type is null) and (activenetwork not in ('GPON' , 'GPON|MOBILE TV', 'GPON|GPON') or activenetwork is null)
group by clean_hfc_nodename 
order by 2 desc
;
...
, count(distinct ticketid) as d_tickets, count(distinct clientcode) as d_clients from rcbill_my.rep_servicetickets_2023 
where month(opendate)=5 and year(opendate)=2023
and (clean_connection_type = 'HFC' or clean_connection_type is null) and (activenetwork not in ('GPON' , 'GPON|MOBILE TV', 'GPON|GPON') or activenetwork is null)
and service='Internet'
group by clean_hfc_nodename 
order by 2 desc
...
select clean_hfc_nodename, count(distinct ticketid) as d_tickets from rcbill_my.rep_servicetickets_2023 
where month(opendate)=4 and year(opendate)=2023
and (clean_connection_type = 'HFC' or clean_connection_type is null) and (activenetwork not in ('GPON' , 'GPON|MOBILE TV', 'GPON|GPON') or activenetwork is null)
group by clean_hfc_nodename 
order by 2 desc
;
...
select clean_hfc_nodename, clientlocation, count(distinct ticketid) as d_tickets from rcbill_my.rep_servicetickets_2023 where month(opendate)=5 and year(opendate)=2023
and (clean_connection_type = 'HFC' or clean_connection_type is null) and (activenetwork not in ('GPON' , 'GPON|MOBILE TV', 'GPON|GPON') or activenetwork is null)
and service='Internet'
