...
(
    ...
    (
		...
		(
                ...
                where year(ASSGN_OPENDATE)=2019  
...
CREATE INDEX IDXrst1 ON rcbill_my.rep_servicetickets_2019 (assgntechregion);
CREATE INDEX IDXrst2 ON rcbill_my.rep_servicetickets_2019 (assgnopendate);
