...
/*
, AVG(45 * (DATEDIFF(ASSGN_CLOSEDATE, ASSGN_OPENDATE) DIV 7) + 9 * MID('0123444401233334012222340111123400001234000123440', 7 * WEEKDAY(ASSGN_OPENDATE) + WEEKDAY(ASSGN_CLOSEDATE) + 1, 1) +  TIMESTAMPDIFF(HOUR, DATE(ASSGN_CLOSEDATE), ASSGN_CLOSEDATE) - TIMESTAMPDIFF(HOUR, DATE(ASSGN_OPENDATE), ASSGN_OPENDATE)) AS average_response5DayWeek
...
, 7 * WEEKDAY(ASSGN_OPENDATE)
, WEEKDAY(ASSGN_CLOSEDATE)
, 5 * MID('0123444401233334012222340111123400001234000123440', 7 * WEEKDAY(ASSGN_OPENDATE) + WEEKDAY(ASSGN_CLOSEDATE) + 1
, ((DATEDIFF(ASSGN_CLOSEDATE, ASSGN_OPENDATE) DIV 7) + 
          5 * MID('0123444401233334012222340111123400001234000123440', 
                  7 * WEEKDAY(ASSGN_OPENDATE) + WEEKDAY(ASSGN_CLOSEDATE) + 1, 1) + 
          TIMESTAMPDIFF(HOUR, DATE(ASSGN_CLOSEDATE), ASSGN_CLOSEDATE) - 
          TIMESTAMPDIFF(HOUR, DATE(ASSGN_OPENDATE), ASSGN_OPENDATE)) AS response5DayWeek
, ((DATEDIFF(ASSGN_CLOSEDATE, ASSGN_OPENDATE) DIV 7) + 
          6 * MID('0123455501234445012333450122234501112345000123450', 
                  7 * WEEKDAY(ASSGN_OPENDATE) + WEEKDAY(ASSGN_CLOSEDATE) + 1, 1) + 
          TIMESTAMPDIFF(HOUR, DATE(ASSGN_CLOSEDATE), ASSGN_CLOSEDATE) - 
          TIMESTAMPDIFF(HOUR, DATE(ASSGN_OPENDATE), ASSGN_OPENDATE)) AS response6DayWeek
