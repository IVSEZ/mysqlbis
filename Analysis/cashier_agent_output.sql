...
-- select * from rcbill_my.sales order by orderdate desc limit 100;


select * from rcbill_my.sales where state in ('Completed','Open') and year(orderday)=2020 and cost>0;
