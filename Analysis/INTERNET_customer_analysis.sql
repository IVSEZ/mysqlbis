...
select * from rcbill_my.customercontractsnapshot where clientcode='I20485';
select min(period) from rcbill_my.customercontractactivity WHERE CLIENTCODE='I20485' and servicecategory;
...
-- SET @enddate = '2022-08-15';

## CHANGE THE TABLE NAME UP
...
(
        ...
        -- , min(period) as FIRST_ACTIVE_DATE
        -- , max(period) as LAST_ACTIVE_DATE
...
### GET FULL OUTER JOIN OF INTERNET CUSTOMERS TO SEE NET GROWTH OR LOSS
