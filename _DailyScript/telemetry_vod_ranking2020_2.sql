...
-- select resource, jan from rcbill_my.rep_vodpivot2020 order by jan desc;

-- select * from rcbill_my.rep_vodpivot2020 order by total_duration desc ;

drop table if exists rcbill_my.rep_vodranking2020_2;

create table rcbill_my.rep_vodranking2020_2 as
(
	...
	from rcbill_my.rep_vodpivot2020
    -- where title is null
...
-- select * from rcbill_my.rep_vodranking2020_2 order by overall asc;
-- select * from rcbill_my.rep_vodranking2020_2 where resource like '2020%' order by overall asc;
