...
-- select resource, jan from rcbill_my.rep_vodpivot2021 order by jan desc;

-- select * from rcbill_my.rep_vodpivot2021 order by total_duration desc ;

drop table if exists rcbill_my.rep_vodranking2021_1;

create table rcbill_my.rep_vodranking2021_1 as
(
	...
	from rcbill_my.rep_vodpivot2021
...
-- select * from rcbill_my.rep_vodranking2021_1 order by overall asc;
-- select * from rcbill_my.rep_vodranking2021_1 where resource like '2021%' order by overall asc;
