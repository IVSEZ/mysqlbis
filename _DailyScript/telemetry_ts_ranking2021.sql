...
-- select resource, jan from rcbill_my.rep_tspivot2021 order by jan desc;

-- select * from rcbill_my.rep_tspivot2021 order by total_sessions desc ;

drop table if exists rcbill_my.rep_tsranking2021;

create table rcbill_my.rep_tsranking2021 as
(
	...
	from rcbill_my.rep_tspivot2021
...
-- select * from rcbill_my.rep_tsranking2021 order by overall asc;