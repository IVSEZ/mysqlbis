...
drop table if exists rcbill_my.budget_actual_2021;

create table rcbill_my.budget_actual_2021 as 
(
...
select count(*) as budget_actual_2021 from rcbill_my.budget_actual_2021;
...
drop table if exists rcbill_my.rep_budget_actual_2021_pv;

create table rcbill_my.rep_budget_actual_2021_pv as 
(
...
select count(*) as rep_budget_actual_2021_pv from rcbill_my.rep_budget_actual_2021_pv;
