...
drop table if exists rcbill_my.rep_vodranking2021_2;

create table rcbill_my.rep_vodranking2021_2 as
(
...
-- select * from rcbill_my.rep_vodranking2021_2 order by overall asc;
-- select * from rcbill_my.rep_vodranking2021_2 where resource like '2021%' order by overall asc;
