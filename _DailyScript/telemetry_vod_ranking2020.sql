...
drop table if exists rcbill_my.rep_vodranking2020;

create table rcbill_my.rep_vodranking2020 as
(
...
-- select * from rcbill_my.rep_vodranking2020 order by overall asc;
-- select * from rcbill_my.rep_vodranking2020 where resource like '2020%' order by overall asc;
