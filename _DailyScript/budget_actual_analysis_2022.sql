...
-- =================================== 
set @revenue=1;
set @m1='2020-01-31';set @m2='2020-02-19';set @m3='2020-03-31';set @m4='2020-04-30';set @m5='2020-05-31';
set @m6='2020-06-30';set @m7='2020-07-31';set @m8='2020-08-31';set @m9='2020-09-30';set @m10='2020-10-31';
set @m11='2020-11-30';set @m12='2020-12-31';

SET @rundate='2020-05-31';
 */   
...
drop table if exists rcbill_my.budget_actual_2022;

create table rcbill_my.budget_actual_2022 as 
(
...
select count(*) as budget_actual_2022 from rcbill_my.budget_actual_2022;
...
/*
	select RUNDATE, CATEGORY, PACKAGE
		...
		from 
		rcbill_my.budget_actual_2020
		group by RUNDATE, CATEGORY, PACKAGE, MTH
        ;
*/

drop table if exists rcbill_my.rep_budget_actual_2022_pv;

create table rcbill_my.rep_budget_actual_2022_pv as 
(
...
select count(*) as rep_budget_actual_2022_pv from rcbill_my.rep_budget_actual_2022_pv;
