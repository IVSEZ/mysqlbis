...
-- LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/DailySubscriptionStats-25082019-02092019.csv'
  ...
  LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/DailySubscriptionStats-27012020.csv'
...
-- 	SET @rundate='2020-01-01'; SET @perioddate=str_to_date('2020-01-01','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-01;2020-01-01.csv'
-- 	SET @rundate='2020-01-02'; SET @perioddate=str_to_date('2020-01-02','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-02;2020-01-02.csv'
-- 	SET @rundate='2020-01-03'; SET @perioddate=str_to_date('2020-01-03','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-03;2020-01-03.csv'
-- 	SET @rundate='2020-01-04'; SET @perioddate=str_to_date('2020-01-04','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-04;2020-01-04.csv'
-- 	SET @rundate='2020-01-05'; SET @perioddate=str_to_date('2020-01-05','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-05;2020-01-05.csv'
-- 	SET @rundate='2020-01-06'; SET @perioddate=str_to_date('2020-01-06','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-06;2020-01-06.csv'
-- 	SET @rundate='2020-01-07'; SET @perioddate=str_to_date('2020-01-07','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-07;2020-01-07.csv'
-- 	SET @rundate='2020-01-08'; SET @perioddate=str_to_date('2020-01-08','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-08;2020-01-08.csv'
-- 	SET @rundate='2020-01-09'; SET @perioddate=str_to_date('2020-01-09','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-09;2020-01-09.csv'
-- 	SET @rundate='2020-01-10'; SET @perioddate=str_to_date('2020-01-10','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-10;2020-01-10.csv'
-- 	SET @rundate='2020-01-11'; SET @perioddate=str_to_date('2020-01-11','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-11;2020-01-11.csv'
-- 	SET @rundate='2020-01-12'; SET @perioddate=str_to_date('2020-01-12','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-12;2020-01-12.csv'
-- 	SET @rundate='2020-01-13'; SET @perioddate=str_to_date('2020-01-13','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-13;2020-01-13.csv'
-- 	SET @rundate='2020-01-14'; SET @perioddate=str_to_date('2020-01-14','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-14;2020-01-14.csv'
-- 	SET @rundate='2020-01-15'; SET @perioddate=str_to_date('2020-01-15','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-15;2020-01-15.csv'
-- 	SET @rundate='2020-01-16'; SET @perioddate=str_to_date('2020-01-16','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-16;2020-01-16.csv'
-- 	SET @rundate='2020-01-17'; SET @perioddate=str_to_date('2020-01-17','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-17;2020-01-17.csv'
-- 	SET @rundate='2020-01-18'; SET @perioddate=str_to_date('2020-01-18','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-18;2020-01-18.csv'
-- 	SET @rundate='2020-01-19'; SET @perioddate=str_to_date('2020-01-19','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-19;2020-01-19.csv'
-- 	SET @rundate='2020-01-20'; SET @perioddate=str_to_date('2020-01-20','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-20;2020-01-20.csv'
-- 	SET @rundate='2020-01-21'; SET @perioddate=str_to_date('2020-01-21','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-21;2020-01-21.csv'
-- 	SET @rundate='2020-01-22'; SET @perioddate=str_to_date('2020-01-22','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-22;2020-01-22.csv'
-- 	SET @rundate='2020-01-23'; SET @perioddate=str_to_date('2020-01-23','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-23;2020-01-23.csv'
-- 	SET @rundate='2020-01-24'; SET @perioddate=str_to_date('2020-01-24','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-24;2020-01-24.csv'
-- 	SET @rundate='2020-01-25'; SET @perioddate=str_to_date('2020-01-25','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-25;2020-01-25.csv'
-- 	SET @rundate='2020-01-26'; SET @perioddate=str_to_date('2020-01-26','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-26;2020-01-26.csv'
 	SET @rundate='2020-01-27'; SET @perioddate=str_to_date('2020-01-27','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-27;2020-01-27.csv'
-- 	SET @rundate='2020-01-28'; SET @perioddate=str_to_date('2020-01-28','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-28;2020-01-28.csv'
-- 	SET @rundate='2020-01-29'; SET @perioddate=str_to_date('2020-01-29','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-29;2020-01-29.csv'
-- 	SET @rundate='2020-01-30'; SET @perioddate=str_to_date('2020-01-30','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-30;2020-01-30.csv'
-- 	SET @rundate='2020-01-31'; SET @perioddate=str_to_date('2020-01-31','%Y-%m-%d');	LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/_csv/2020-01-31;2020-01-31.csv'
