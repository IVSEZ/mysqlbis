...
-- LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/activenumber/DailySubscriptionStats-05052018-06052018.csv'
 ...
 LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/activenumber/DailySubscriptionStats-22052018.csv'
...
call sp_ActiveNumber(22,05,2018,'','');

call sp_GetActiveNumberFromTo('2018-05-21','2018-05-22');
