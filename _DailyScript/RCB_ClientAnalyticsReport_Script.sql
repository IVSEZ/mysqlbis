...
#2. Create ClientContract summary table
		...
		CREATE INDEX IDXClientContracts7
		ON clientcontracts (CONTRACTCURRENTSTATUS, S_SERVICENAME);
		CREATE INDEX IDXClientContracts8
		ON clientcontracts (CONTRACTCURRENTSTATUS, CL_CLIENTID);
