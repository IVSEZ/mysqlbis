...
#SET DATE
SET @REPORTDATE=str_to_date('2021-12-06','%Y-%m-%d');


SET @rundate='2021-12-06';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2021-12-06';
set @periodend='2021-12-06';	


SET @rundate='2021-12-06';

#FOR Daily calls script
SET @date1='2021-12-06';
SET @date2='2021-12-07';  ### to be one day later
