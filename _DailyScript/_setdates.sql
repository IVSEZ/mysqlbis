...
#SET DATE
SET @REPORTDATE=str_to_date('2023-01-15','%Y-%m-%d');


SET @rundate='2023-01-15';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2023-01-15';
set @periodend='2023-01-15';	
...
SET @date2='2023-01-16';  ### to be one day later
