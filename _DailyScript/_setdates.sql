...
#SET DATE
SET @REPORTDATE=str_to_date('2022-01-27','%Y-%m-%d');


SET @rundate='2022-01-27';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2022-01-27';
set @periodend='2022-01-27';	


SET @rundate='2022-01-27';

#FOR Daily calls script
SET @date1='2022-01-27';
SET @date2='2022-01-28';  ### to be one day later
