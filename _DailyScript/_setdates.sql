...
#SET DATE
SET @REPORTDATE=str_to_date('2022-01-16','%Y-%m-%d');


SET @rundate='2022-01-16';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2022-01-16';
set @periodend='2022-01-16';	


SET @rundate='2022-01-16';

#FOR Daily calls script
SET @date1='2022-01-16';
SET @date2='2022-01-17';  ### to be one day later
