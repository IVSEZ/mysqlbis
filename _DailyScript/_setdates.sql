...
#SET DATE
SET @REPORTDATE=str_to_date('2022-01-05','%Y-%m-%d');


SET @rundate='2022-01-05';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2022-01-05';
set @periodend='2022-01-05';	


SET @rundate='2022-01-05';

#FOR Daily calls script
SET @date1='2022-01-05';
SET @date2='2022-01-06';  ### to be one day later
