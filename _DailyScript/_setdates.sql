...
#SET DATE
SET @REPORTDATE=str_to_date('2022-10-24','%Y-%m-%d');


SET @rundate='2022-10-24';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2022-10-24';
set @periodend='2022-10-24';	


SET @rundate='2022-10-24';

#FOR Daily calls script
SET @date1='2022-10-24';
SET @date2='2022-10-25';  ### to be one day later
