...
#SET DATE
SET @REPORTDATE=str_to_date('2021-08-31','%Y-%m-%d');

SET @rundate='2021-08-31';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2021-08-31';
set @periodend='2021-08-31';	


SET @rundate='2021-08-31';

#FOR Daily calls script
SET @date1='2021-08-31';
SET @date2='2021-08-31';
