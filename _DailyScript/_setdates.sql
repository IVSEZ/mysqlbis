...
#SET DATE
SET @REPORTDATE=str_to_date('2021-05-07','%Y-%m-%d');

SET @rundate='2021-05-07';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2021-05-07';
set @periodend='2021-05-07';


SET @rundate='2021-05-07';

#FOR Daily calls script
SET @date1='2021-05-07';
SET @date2='2021-05-08';
