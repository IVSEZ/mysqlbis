...
#SET DATE
SET @REPORTDATE=str_to_date('2022-06-30','%Y-%m-%d');


SET @rundate='2022-06-30';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2022-06-30';
set @periodend='2022-06-30';	


SET @rundate='2022-06-30';

#FOR Daily calls script
SET @date1='2022-06-30';
SET @date2='2022-07-01';  ### to be one day later
