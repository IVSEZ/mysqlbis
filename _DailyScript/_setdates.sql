...
#SET DATE
SET @REPORTDATE=str_to_date('2022-07-25','%Y-%m-%d');


SET @rundate='2022-07-25';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2022-07-25';
set @periodend='2022-07-25';	


SET @rundate='2022-07-25';

#FOR Daily calls script
SET @date1='2022-07-25';
SET @date2='2022-07-26';  ### to be one day later
