...
#SET DATE
SET @REPORTDATE=str_to_date('2021-05-27','%Y-%m-%d');

SET @rundate='2021-05-27';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2021-05-27';
set @periodend='2021-05-27';


SET @rundate='2021-05-27';

#FOR Daily calls script
SET @date1='2021-05-27';
SET @date2='2021-05-28';
