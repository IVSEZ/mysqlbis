...
#SET DATE
SET @REPORTDATE=str_to_date('2022-08-08','%Y-%m-%d');


SET @rundate='2022-08-08';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2022-08-08';
set @periodend='2022-08-08';	


SET @rundate='2022-08-08';

#FOR Daily calls script
SET @date1='2022-08-08';
SET @date2='2022-08-09';  ### to be one day later
