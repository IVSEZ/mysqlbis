...
#SET DATE
SET @REPORTDATE=str_to_date('2021-08-18','%Y-%m-%d');

SET @rundate='2021-08-18';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2021-08-18';
set @periodend='2021-08-18';	


SET @rundate='2021-08-18';

#FOR Daily calls script
SET @date1='2021-08-18';
SET @date2='2021-08-19';
