...
#SET DATE
SET @REPORTDATE=str_to_date('2021-11-15','%Y-%m-%d');


SET @rundate='2021-11-15';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2021-11-15';
set @periodend='2021-11-15';	


SET @rundate='2021-11-15';

#FOR Daily calls script
SET @date1='2021-11-15';
SET @date2='2021-11-16';  ### to be one day later
