...
#SET DATE
SET @REPORTDATE=str_to_date('2022-10-27','%Y-%m-%d');


SET @rundate='2022-10-27';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2022-10-27';
set @periodend='2022-10-27';	


SET @rundate='2022-10-27';

#FOR Daily calls script
SET @date1='2022-10-27';
SET @date2='2022-10-28';  ### to be one day later
