...
call rcbill_my.sp_fillalldates('2016-05-29',DATE_SUB(date(NOW()), INTERVAL 1 DAY));
...
#SET DATE
SET @REPORTDATE=str_to_date('2022-05-29','%Y-%m-%d');


SET @rundate='2022-05-29';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2022-05-29';
set @periodend='2022-05-29';	


SET @rundate='2022-05-29';

#FOR Daily calls script
SET @date1='2022-05-29';
SET @date2='2022-05-30';  ### to be one day later
