...
#SET DATE
SET @REPORTDATE=str_to_date('2022-01-26','%Y-%m-%d');


SET @rundate='2022-01-26';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2022-01-26';
set @periodend='2022-01-26';	


SET @rundate='2022-01-26';

#FOR Daily calls script
SET @date1='2022-01-26';
SET @date2='2022-01-27';  ### to be one day later
