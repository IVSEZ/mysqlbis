...
#SET DATE
SET @REPORTDATE=str_to_date('2022-06-06','%Y-%m-%d');


SET @rundate='2022-06-06';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2022-06-06';
set @periodend='2022-06-06';	


SET @rundate='2022-06-06';

#FOR Daily calls script
SET @date1='2022-06-06';
SET @date2='2022-06-07';  ### to be one day later
