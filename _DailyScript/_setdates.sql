...
#SET DATE
SET @REPORTDATE=str_to_date('2021-09-02','%Y-%m-%d');

SET @rundate='2021-09-02';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2021-09-02';
set @periodend='2021-09-02';	


SET @rundate='2021-09-02';

#FOR Daily calls script
SET @date1='2021-09-02';
SET @date2='2021-09-03';
