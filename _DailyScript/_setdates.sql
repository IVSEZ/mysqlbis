...
#SET DATE
SET @REPORTDATE=str_to_date('2022-07-11','%Y-%m-%d');


SET @rundate='2022-07-11';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2022-07-11';
set @periodend='2022-07-11';	


SET @rundate='2022-07-11';

#FOR Daily calls script
SET @date1='2022-07-11';
SET @date2='2022-07-12';  ### to be one day later
