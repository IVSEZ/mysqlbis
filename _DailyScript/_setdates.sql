...
#SET DATE
SET @REPORTDATE=str_to_date('2021-05-23','%Y-%m-%d');

SET @rundate='2021-05-23';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2021-05-23';
set @periodend='2021-05-23';


SET @rundate='2021-05-23';

#FOR Daily calls script
SET @date1='2021-05-23';
SET @date2='2021-05-24';
