...
#SET DATE
SET @REPORTDATE=str_to_date('2021-06-01','%Y-%m-%d');

SET @rundate='2021-06-01';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2021-06-01';
set @periodend='2021-06-01';	


SET @rundate='2021-06-01';

#FOR Daily calls script
SET @date1='2021-06-01';
SET @date2='2021-06-02';
