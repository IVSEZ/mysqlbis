...
#SET DATE
SET @REPORTDATE=str_to_date('2022-11-03','%Y-%m-%d');


SET @rundate='2022-11-03';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2022-11-03';
set @periodend='2022-11-03';	


SET @rundate='2022-11-03';

#FOR Daily calls script
SET @date1='2022-11-03';
SET @date2='2022-11-04';  ### to be one day later
