...
#SET DATE
SET @REPORTDATE=str_to_date('2021-05-24','%Y-%m-%d');

SET @rundate='2021-05-24';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2021-05-24';
set @periodend='2021-05-24';


SET @rundate='2021-05-24';

#FOR Daily calls script
SET @date1='2021-05-24';
SET @date2='2021-05-25';
