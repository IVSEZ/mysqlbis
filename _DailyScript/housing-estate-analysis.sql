...
select date(now()) as reportdate, a.ClientCode, a.ClientName,a.ClientAddress,a.ClientArea,a.ClientLocation, ifnull(b.firstactivedate,'') as firstactivedate, ifnull(b.lastactivedate,'') as lastactivedate,
