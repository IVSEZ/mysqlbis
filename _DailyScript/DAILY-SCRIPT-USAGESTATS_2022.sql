...
create table rcbill_my.rep_dailypackageusage2022(index idxrdpu1(usagedate), index idxrdpu2(package)) as
(
	...
	from rcbill.clientcontractipusage where year(USAGEDATE)=2022
	group by 1,2,3
	order by 1 desc
