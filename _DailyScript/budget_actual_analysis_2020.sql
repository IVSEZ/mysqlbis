...
drop table if exists rcbill_my.budget_actual_2020;

create table rcbill_my.budget_actual_2020 as 
(
...
select count(*) as budget_actual_2020 from rcbill_my.budget_actual_2020;
...
drop table if exists rcbill_my.rep_budget_actual_2020_pv;

create table rcbill_my.rep_budget_actual_2020_pv as 
(
...
select count(*) as rep_budget_actual_2020_pv from rcbill_my.rep_budget_actual_2020_pv;
