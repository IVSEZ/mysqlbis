...
-- select resource, jan from rcbill_my.rep_livetvpivot2020 order by jan desc;

-- select * from rcbill_my.rep_livetvpivot2020 order by total_duration desc ;


drop table if exists rcbill_my.rep_livetvranking2020;

create table rcbill_my.rep_livetvranking2020 as
(
		...
		from rcbill_my.rep_livetvpivot2020
...
-- select * from rcbill_my.rep_livetvranking2020 order by overall asc;