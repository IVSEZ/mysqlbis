...
-- select resource, jan from rcbill_my.rep_tspivot2019 order by jan desc;

-- select * from rcbill_my.rep_tspivot2019 order by total_sessions desc ;

drop table if exists rcbill_my.rep_tsranking2019;

create table rcbill_my.rep_tsranking2019 as
(
	...
	from rcbill_my.rep_tspivot2019
...
-- select * from rcbill_my.rep_tsranking2019 order by overall asc;