...
-- select resource, jan from rcbill_my.rep_radiopivot2020 order by jan desc;

-- select * from rcbill_my.rep_radiopivot2020 order by total_duration desc ;

drop table if exists rcbill_my.rep_radioranking2020;

create table rcbill_my.rep_radioranking2020 as
(
	...
	from rcbill_my.rep_radiopivot2020
...
-- select * from rcbill_my.rep_radioranking2020 order by overall asc;