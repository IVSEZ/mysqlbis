...
-- select resource, jan from rcbill_my.rep_tspivot2022 order by jan desc;

-- select * from rcbill_my.rep_tspivot2022 order by total_sessions desc ;

drop table if exists rcbill_my.rep_tsranking2022;

create table rcbill_my.rep_tsranking2022 as
(
	...
	from rcbill_my.rep_tspivot2022
...
-- select * from rcbill_my.rep_tsranking2022 order by overall asc;