...
drop table if exists rcbill_my.rep_vodranking2021;

create table rcbill_my.rep_vodranking2021 as
(
...
-- select * from rcbill_my.rep_vodranking2021 order by overall asc;
-- select * from rcbill_my.rep_vodranking2021 where resource like '2021%' order by overall asc;
