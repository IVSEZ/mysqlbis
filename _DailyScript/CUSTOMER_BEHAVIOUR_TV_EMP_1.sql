...
set @datee='2018-09-30';
	...
	drop table if exists rcbill_my.tempcustbehe1;
	drop table if exists rcbill_my.tempcustbehe2;


    create table rcbill_my.tempcustbehe1 as 
    (
		SELECT 
			period,
				periodday,
		...
		WHERE
			...
			/*
				...
				*/
                ...
                and upper(clienttype) in ('EMPLOYEE')
    ...
    create table rcbill_my.tempcustbehe2 as 
    (
    ...
    select * from rcbill_my.tempcustbehe1;
    
    select * from rcbill_my.tempcustbehe2 
    ;
    -- where standalone>1;
	-- where packages like '%DUAL%';	
 
    -- SET @clientcode='I22063'; -- 'I.000015664'; -- 'I9107';
...
####################################################
### PIVOT
select 'EMP' as ctype, concat(standalone,"|", addon) as combo, standalone, addon, periodyear, periodmth
, count(distinct clientcode) as dcl
from 
rcbill_my.tempcustbehe2 
group by 1, 2, standalone, addon, periodyear, periodmth
order by standalone, addon, periodyear, periodmth
; 

select 'EMP' as ctype, periodyear, periodmth
, count(distinct clientcode) as dcl
from 
rcbill_my.tempcustbehe2 
