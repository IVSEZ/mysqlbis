...
drop table if exists rcbill_my.rep_vodranking2023;

create table rcbill_my.rep_vodranking2023 as
(
...
-- select * from rcbill_my.rep_vodranking2023 order by overall asc;
-- select * from rcbill_my.rep_vodranking2023 where resource like '2023%' order by overall asc;
