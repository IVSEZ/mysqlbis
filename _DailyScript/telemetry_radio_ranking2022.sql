...
-- select resource, jan from rcbill_my.rep_radiopivot2022 order by jan desc;

-- select * from rcbill_my.rep_radiopivot2022 order by total_duration desc ;

drop table if exists rcbill_my.rep_radioranking2022;

create table rcbill_my.rep_radioranking2022 as
(
	...
	from rcbill_my.rep_radiopivot2022
...
-- select * from rcbill_my.rep_radioranking2022 order by overall asc;