...
drop table if exists rcbill_my.rep_vodranking2023_2;

create table rcbill_my.rep_vodranking2023_2 as
(
...
-- select * from rcbill_my.rep_vodranking2023_2 order by overall asc;
-- select * from rcbill_my.rep_vodranking2023_2 where resource like '2023%' order by overall asc;
