...
-- select resource, jan from rcbill_my.rep_livetvpivot2019 order by jan desc;

-- select * from rcbill_my.rep_livetvpivot2019 order by total_duration desc ;


drop table if exists rcbill_my.rep_livetvranking2019;

create table rcbill_my.rep_livetvranking2019 as
(
		...
		from rcbill_my.rep_livetvpivot2019
...
-- select * from rcbill_my.rep_livetvranking2019 order by overall asc;