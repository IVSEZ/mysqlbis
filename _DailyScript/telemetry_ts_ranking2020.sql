...
-- select resource, jan from rcbill_my.rep_tspivot2020 order by jan desc;

-- select * from rcbill_my.rep_tspivot2020 order by total_sessions desc ;

drop table if exists rcbill_my.rep_tsranking2020;

create table rcbill_my.rep_tsranking2020 as
(
	...
	from rcbill_my.rep_tspivot2020
...
-- select * from rcbill_my.rep_tsranking2020 order by overall asc;