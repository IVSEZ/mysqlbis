...
-- select resource, jan from rcbill_my.rep_livetvpivot2023 order by jan desc;

-- select * from rcbill_my.rep_livetvpivot2023 order by total_duration desc ;


drop table if exists rcbill_my.rep_livetvranking2023;

create table rcbill_my.rep_livetvranking2023 as
(
		...
		from rcbill_my.rep_livetvpivot2023
...
-- select * from rcbill_my.rep_livetvranking2022 order by overall asc;