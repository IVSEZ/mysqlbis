...
drop table if exists rcbill_my.rep_vodranking2019;

create table rcbill_my.rep_vodranking2019 as
(
...
-- select * from rcbill_my.rep_vodranking2019 order by overall asc;
-- select * from rcbill_my.rep_vodranking2019 where resource like '2019%' order by overall asc;
