...
drop table if exists rcbill_my.salestoactive_MV;
create table rcbill_my.salestoactive_MV as
(
...
select * from rcbill_my.salestoactive_MV order by o_orderdate ;
...
from 
( select * from rcbill_my.clientstats where multiview>0 ) a
