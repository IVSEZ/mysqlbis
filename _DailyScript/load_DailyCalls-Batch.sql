...
#FOR Daily calls script
 SET @date1='2022-10-21';
 SET @date2='2022-10-24';  ### to be one day later

  LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 5.7\\Uploads\\CC\\distribution_detail-CC-21102022-23102022.csv'
