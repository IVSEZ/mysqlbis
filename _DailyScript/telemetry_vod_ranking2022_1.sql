...
drop table if exists rcbill_my.rep_vodranking2022_1;

create table rcbill_my.rep_vodranking2022_1 as
(
...
-- select * from rcbill_my.rep_vodranking2022_1 order by overall asc;
-- select * from rcbill_my.rep_vodranking2022_1 where resource like '2022%' order by overall asc;
