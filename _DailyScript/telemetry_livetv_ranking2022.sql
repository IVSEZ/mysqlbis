...
-- select resource, jan from rcbill_my.rep_livetvpivot2022 order by jan desc;

-- select * from rcbill_my.rep_livetvpivot2022 order by total_duration desc ;


drop table if exists rcbill_my.rep_livetvranking2022;

create table rcbill_my.rep_livetvranking2022 as
(
		...
		from rcbill_my.rep_livetvpivot2022
