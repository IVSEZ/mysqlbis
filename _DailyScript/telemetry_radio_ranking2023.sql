...
-- select resource, jan from rcbill_my.rep_radiopivot2023 order by jan desc;

-- select * from rcbill_my.rep_radiopivot2023 order by total_duration desc ;

drop table if exists rcbill_my.rep_radioranking2023;

create table rcbill_my.rep_radioranking2023 as
(
	...
	from rcbill_my.rep_radiopivot2023
...
-- select * from rcbill_my.rep_radioranking2023 order by overall asc;