...
(
		select clid, clientcode, cid, contractcode
##added on 20230104 to cater for 2023 data
		, ifnull(sum(`202301`),0) as `202301` 
		, ifnull(sum(`202302`),0) as `202302` 
		, ifnull(sum(`202303`),0) as `202303` 
		, ifnull(sum(`202304`),0) as `202304` 
		, ifnull(sum(`202305`),0) as `202305` 
		, ifnull(sum(`202306`),0) as `202306` 
		, ifnull(sum(`202307`),0) as `202307` 
		, ifnull(sum(`202308`),0) as `202308` 
		, ifnull(sum(`202309`),0) as `202309` 
		, ifnull(sum(`202310`),0) as `202310` 
		, ifnull(sum(`202311`),0) as `202311` 
		, ifnull(sum(`202312`),0) as `202312` 
		, ifnull(sum(TotalPayments2023),0) as TotalPayments2023
		, ifnull(sum(TotalPaymentAmount2023),0) as TotalPaymentAmount2023
		...
		(    
			select clid, clientcode, cid, contractcode
				,case when paymonth=1 and payyear=2023 then ifnull(sum(totalpaymentamount),0) end as `202301`
				,case when paymonth=2 and payyear=2023 then ifnull(sum(totalpaymentamount),0) end as `202302`
				,case when paymonth=3 and payyear=2023 then ifnull(sum(totalpaymentamount),0) end as `202303`
				,case when paymonth=4 and payyear=2023 then ifnull(sum(totalpaymentamount),0) end as `202304`
				,case when paymonth=5 and payyear=2023 then ifnull(sum(totalpaymentamount),0) end as `202305`
				,case when paymonth=6 and payyear=2023 then ifnull(sum(totalpaymentamount),0) end as `202306`
				,case when paymonth=7 and payyear=2023 then ifnull(sum(totalpaymentamount),0) end as `202307`
				,case when paymonth=8 and payyear=2023 then ifnull(sum(totalpaymentamount),0) end as `202308`
				,case when paymonth=9 and payyear=2023 then ifnull(sum(totalpaymentamount),0) end as `202309`
				,case when paymonth=10 and payyear=2023 then ifnull(sum(totalpaymentamount),0) end as `202310`
				,case when paymonth=11 and payyear=2023 then ifnull(sum(totalpaymentamount),0) end as `202311`
				,case when paymonth=12 and payyear=2023 then ifnull(sum(totalpaymentamount),0) end as `202312`
				,case when payyear=2023 then ifnull(sum(totalpayments),0) end as TotalPayments2023
				,case when payyear=2023 then ifnull(sum(totalpaymentamount),0) end as TotalPaymentAmount2023
...
(
        ...
        , a.`202301`, a.`202302`, a.`202303`, a.`202304`, a.`202305`, a.`202306`, a.`202307`, a.`202308`, a.`202309`, a.`202310`, a.`202311`, a.`202312`, a.`TotalPayments2023`, a.`TotalPaymentAmount2023`
...
(
    ...
    (
            ...
            -- added 04 Jan 2023
			, sum(`202301`) as `202301`, sum(`202302`) as `202302`, sum(`202303`) as `202303`, sum(`202304`) as `202304`
			, sum(`202305`) as `202305`, sum(`202306`) as `202306`, sum(`202307`) as `202307`, sum(`202308`) as `202308`
			, sum(`202309`) as `202309`, sum(`202310`) as `202310`, sum(`202311`) as `202311`, sum(`202312`) as `202312`
			, sum(`TotalPayments2023`) as `TotalPayments2023`
			, sum(`TotalPaymentAmount2023`) as `TotalPaymentAmount2023`       
...
(
	...
	`202312`,
	`totalpayments2023`,
	`totalpaymentamount2023`,
    `AvgMonthlyPayment2023`,
	...
	(
        ...
        ((b.totalpaymentamount2022)/12) as AvgMonthlyPayment2022,
     
     -- added on 04 Jan 2023
        ((b.totalpaymentamount2023)/MONTH(now())) as AvgMonthlyPayment2023,
...
, TotalPaymentAmount2023, AvgMonthlyPayment2023
