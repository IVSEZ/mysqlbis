...
drop table if exists rcbill_my.rep_livetvpivot2020;

create table rcbill_my.rep_livetvpivot2020 as 
(
	...
	where view_date>='2020-01-01' and view_date<='2020-12-31'
	GROUP BY 1
	order by 1
)
;

drop table if exists rcbill_my.rep_vodpivot2020;

create table rcbill_my.rep_vodpivot2020 as 
(
...
drop table if exists rcbill_my.rep_radiopivot2020;

create table rcbill_my.rep_radiopivot2020 as 
(
	SELECT  upper(trim(resource)) as RESOURCE,
		SUM( IF( MONTH(view_date) = 1, duration_sec, 0) ) AS `JAN`,
		SUM( IF( MONTH(view_date) = 2, duration_sec, 0) ) AS `FEB`,
...
drop table if exists rcbill_my.rep_tspivot2020;

create table rcbill_my.rep_tspivot2020 as 
(
	SELECT  upper(trim(resource)) as RESOURCE,
...
-- select * from rcbill_my.rep_livetvpivot2020 order by total_duration desc ;
/*
...
select * from rcbill_my.rep_livetvpivot2020;
select * from rcbill_my.rep_vodpivot2020;
select * from rcbill_my.rep_radiopivot2020;
select * from rcbill_my.rep_tspivot2020;
*/