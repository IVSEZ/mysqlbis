...
-- select resource, jan from rcbill_my.rep_livetvpivot2017 order by jan desc;

select * from rcbill_my.rep_livetvpivot2017 order by total_duration desc ;


drop table if exists rcbill_my.rep_livetvranking2017;

create table rcbill_my.rep_livetvranking2017 as
(
		...
		from rcbill_my.rep_livetvpivot2017
...
select * from rcbill_my.rep_livetvranking2017 order by overall asc;