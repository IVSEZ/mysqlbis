...
-- select resource, jan from rcbill_my.rep_radiopivot2019 order by jan desc;

-- select * from rcbill_my.rep_radiopivot2019 order by total_duration desc ;

drop table if exists rcbill_my.rep_radioranking2019;

create table rcbill_my.rep_radioranking2019 as
(
	...
	from rcbill_my.rep_radiopivot2019
...
-- select * from rcbill_my.rep_radioranking2019 order by overall asc;