...
#SET DATE
SET @REPORTDATE=str_to_date('2022-07-03','%Y-%m-%d');


SET @rundate='2022-07-03';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2022-07-03';
...
SET @date1='2022-07-03';
SET @date2='2022-07-04';  ### to be one day later
