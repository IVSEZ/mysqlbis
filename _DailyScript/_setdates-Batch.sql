...
#SET DATE
SET @REPORTDATE=str_to_date('2022-10-02','%Y-%m-%d');


SET @rundate='2022-10-02';

SET @COLNAME1='CLIENTDEBT_REPORTDATE';

set @periodstart='2022-10-02';
...
SET @date1='2022-10-02';
SET @date2='2022-10-03';  ### to be one day later
