...
drop table if exists rcbill_my.rep_vodranking2018_2;

create table rcbill_my.rep_vodranking2018_2 as
(
...
-- select * from rcbill_my.rep_vodranking2018_2 order by overall asc;
-- select * from rcbill_my.rep_vodranking2018_2 where resource like '2018%' order by overall asc;
