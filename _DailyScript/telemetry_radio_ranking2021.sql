...
-- select resource, jan from rcbill_my.rep_radiopivot2021 order by jan desc;

-- select * from rcbill_my.rep_radiopivot2021 order by total_duration desc ;

drop table if exists rcbill_my.rep_radioranking2021;

create table rcbill_my.rep_radioranking2021 as
(
	...
	from rcbill_my.rep_radiopivot2021
...
-- select * from rcbill_my.rep_radioranking2021 order by overall asc;