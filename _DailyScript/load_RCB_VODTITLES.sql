...
LOAD DATA LOW_PRIORITY LOCAL INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 5.7\\Uploads\\rcbill\\ALLVOD2TITLES-01112022.csv' 
...
-- select * from rcbill.rcb_vodtitles where id>1000 and titletype='N';
