DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_ActiveNumberNA`(IN pdday int, IN pdmth int, IN pdyr int, IN decom varchar(1), IN rpt varchar(1))
BEGIN
