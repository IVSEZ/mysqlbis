drop table if exists activenumber;
...
CREATE INDEX IDXan1
ON activenumber (period);

CREATE INDEX IDXan2
ON activenumber (servicecategory);

CREATE INDEX IDXan3
ON activenumber (servicesubcategory);

CREATE INDEX IDXan4
ON activenumber (servicetype);

CREATE INDEX IDXan5
ON activenumber (clientclass);

CREATE INDEX IDXan6
ON activenumber (clienttype);

CREATE INDEX IDXan7
ON activenumber (decommissioned);

CREATE INDEX IDXan8
ON activenumber (reported);
